    ...
    <p>
        <form method="POST" action="/register">
            ...
            <div class="space-y-12">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input id="password" name="password_confirmation" type="password" required></x-form-input>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <a href="\" class="rounded-md bg-white px-3 py-2 text-sm/6 font-semibold text-black">Cancel</a>
